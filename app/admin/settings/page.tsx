...
export default function AdminSettings() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="mb-8">
        <h1 className="text-3xl text-center font-bold text-white-900">Pengaturan Restoran</h1>
        <p className="text-white-600 mt-2 text-center">Kelola informasi dasar restoran</p>
      </div>
